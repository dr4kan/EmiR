...
#' @param  alpha_evolution scale parameter for the change of `alpha_vel` with the iterations. Default is `1.0`.
#' @param cognitive cognitive learning factor, influencing the motion of the particle on
#' the basis of distance between its current and best positions. Default is `2.0`.
#' @param social social learning factor, influencing the motion of the particle on
#' the basis of distance between its current position and the best position in the swarm. Default is `2.0`.
#' @param inertia inertia factor, influencing the dependency of the velocity on
