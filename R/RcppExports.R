...
#' print(cs)
#' @export
minimize_CS <- function(cost_function, parameters, config) {
    .Call('_EmiR_minimize_CS', PACKAGE = 'EmiR', cost_function, parameters, config)
}
...
#' print(ga)
#' @export
minimize_GA <- function(cost_function, parameters, config) {
    .Call('_EmiR_minimize_GA', PACKAGE = 'EmiR', cost_function, parameters, config)
}
