...
setMethod(f = "show",
          ...
          definition = function(object) {
            ...
            cat("    absolute tolerance:", object@absolute_tol, "\n")
            cat("gravitational constant:", object@grav, "\n")
            cat("        grav_evolution:", object@grav_evolution, "\n")
          }
)
