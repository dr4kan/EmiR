...
S4 cpp_minimize_ihs(Function obj_function,
  ...
  ihs.setMaximize(maximize);
  ihs.savePopulation(save_pop_history);
  ihs.setConstrainedMethod(constrained_method);
  ihs.setPenaltyScaling(penalty_scale);
  ihs.setStartPenaltyCoeff(start_penalty_param);
  ihs.setMaxPenaltyCoeff(max_penalty_param);
  ihs.setCostrInitPop(constr_init_pop);
