...
// cpp_minimize_new
S4 cpp_minimize_new(Function obj_function, List constraints, List parameters, S4 config, S4 opt);
RcppExport SEXP _EmiR_cpp_minimize_new(SEXP obj_functionSEXP, SEXP constraintsSEXP, SEXP parametersSEXP, SEXP configSEXP, SEXP optSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Function >::type obj_function(obj_functionSEXP);
    ...
    Rcpp::traits::input_parameter< S4 >::type config(configSEXP);
    Rcpp::traits::input_parameter< S4 >::type opt(optSEXP);
    rcpp_result_gen = Rcpp::wrap(cpp_minimize_new(obj_function, constraints, parameters, config, opt));
    return rcpp_result_gen;
END_RCPP
}
// cpp_minimize_ps
