...
void PSMinimization::setParametersRange(const ParametersRange &t) {
  m_parameters_range = t;
};
//_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/

void PSMinimization::checkParameterBoundary() {
...
void PSMinimization::checkParameterBoundary(const std::vector<double>&  v, int it) {
...
void PSMinimization::fit(std::function<double (double*)> func) {
  cost_history.clear();
