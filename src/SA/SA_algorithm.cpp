...
m_population(SAPopulation(obj_function)) {
  ...
  m_algo_config.setAnnealingScheduleString(config.slot("annealing_schedule"));
};
//_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/


void SA_algorithm::addPopulationPosition() {
  std::vector<double> v;
...
void SA_algorithm::minimize() {
  ...
  for (m_iter = 1; m_iter < n_iter; ++m_iter) {
    ...
    m_population.updateTemperature(m_iter);

    // Random walk
    m_population.randomWalk();
