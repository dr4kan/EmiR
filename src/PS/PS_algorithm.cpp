...
PS_algorithm::PS_algorithm(Function obj_function, S4 config) :
  ...
  m_algo_config.setAlpha(config.slot("alpha_vel"));
  m_algo_config.setAlphaEvolution(config.slot("alpha_evolution"));
  m_algo_config.setInertia(config.slot("inertia"));
}
//_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/_/

void PS_algorithm::setSeed(uint64_t t_seed) {
...
void PS_algorithm::minimize() {
  ...
  for (m_iter = 1; m_iter < n_iter; ++m_iter) {
    ...
    m_population.moveParticles(m_iter - 1);
